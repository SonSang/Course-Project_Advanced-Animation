...
public:
    ...
    // Project the given quaternion point [ q ] on the geodesic curve 
    // on SO(3) generated by this quaternion and given axis [ axis ]. 
    quaternion project_geodesic(const quaternion &q, const vec3d &axis);
};
